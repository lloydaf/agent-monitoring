...
while($print_num_array=mysqli_fetch_array($print_num_query)){
	...
	$date_query=mysqli_query($con,"SELECT * from visit where username = '$username_salesperson' and contact_no = '".$print_num_array['contact_no']."'");
?>
<tr>
